<template>
    ...
    >
      <template v-slot:top>
        <v-toolbar flat>
          <v-toolbar-title>รายชื่อลงทะเบียนเเล้ว</v-toolbar-title>
          ...
          <v-dialog v-model="dialogDelete" max-width="500px">
            <v-card>
              <v-card-title class="text-h5">คุณแน่ใจหรือไม่ว่าต้องการลบรายการนี้?</v-card-title>
              <v-card-actions>
                <v-spacer></v-spacer>
  ...
  export default {
    data: () => ({
      ...
      headers: [
        { title: 'ID', key: 'id' },
        { title: 'ชื่อ', key: 'displayName' },
        { title: 'แผนก', key: 'dept' },
        { title: 'เเก้ไข/ลบ', key: 'actions', sortable: false },
      ],
      staffs: [],
      editedIndex: -1,
      editedItem: {},
